...
\begin{remark}
    ...
    \] где след \({ \tau }\) отвечает вложению \({ \Omega \hookrightarrow \mathbb R_{t} \times \Omega\,, \ \omega \mapsto (0, \omega) }\). Это следует непосредственно из формулы (\ref{eq:original_contribution}) и соотношения \[
